...
const About = () => {
  return (
    ...
    <div className='py-4'>
      <p className='text-xl py-4 text-left'>We made a new start. A start that will build beautiful<br />relationships,shape millions of ideas: Enable a new way<br />to live, learn, work and earn.<br />At AER, we build products and services of the future to<br />make your business dreams a reality.
      </p>
