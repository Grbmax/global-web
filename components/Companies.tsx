        ...
        renderContent={({ progress }) => (
          <CompanyContainer>
            ...
            <CompanyRight progress={progress}>
              ...
              <br />
              <p className="italic font-bold text-[20px] md:text-[22px]  lg:text-2xl flex justify-center lg:justify-start">
        ...
        renderContent={({ progress }) => (
          <CompanyContainer>
            <CompanyLeft progress={progress}>
              <figure className="snip0015">
                <Image
                  src="/assets/consultancyhero.png"
                  layout="responsive"
                  width={600}
                  height={600}
                  alt="Aer Consultancy"
