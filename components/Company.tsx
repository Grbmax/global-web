...
export const CompanyTop: React.FC<Props> = ({ children }) => (
    <div className='flex flex-row items-center w-full   md:text-xl lg:text-[32px] top-2 absolute text-white'>
        {children}
    </div>
)

export const CompanyBottom: React.FC<Props> = ({ children }) => (
    <div className='flex flex-row items-center w-full md:text-xl lg:text-[32px] bottom-1 absolute text-white'>
        {children}
    </div>
)
...
export const CompanyRight: React.FC<Right> = ({ children, progress }) => {
    ...
    return (
        <div>
            <div className='flex flex-col px-10 items-start text-xl lg:text-2xl h-half-screen'
                style={{
