...
function MobileNav({ open, setOpen }) {
    return (
        <div className={` top-0 left-0 h-screen w-full bg-black text-white fixed z-50 bg-opacity-95 transform ${open ? "-translate-y-0" : "-translate-y-full"} transition-transform duration-300 ease-in-out filter  `}>
...
export default function Navbar() {
    ...
    return (
        <nav>
            ...
            <div className="w-full bg-black flex p-5 pl-10 pt-6 items-center fixed z-50">
